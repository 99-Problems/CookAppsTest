...
public partial class GTMPro : MonoBehaviour
{
    ...
    public void SetEditString()
    {
        ...
        
        {
            ...
            {
                default:
                    fontKey = "Changa-Bold SDF.asset";
                    matKey = $"{text.fontSharedMaterial.name}.mat";
                    break;
            }
            var font_assetPath = String.Concat("Assets/CookApps/ui/font/", fontKey);
            ...
            var mat_assetPath = String.Concat("Assets/CookApps/ui/font/", matKey);
    ...
    {
        string path = "Assets/CookApps/Prefabs/scripts/string/stringEnglish.json";
