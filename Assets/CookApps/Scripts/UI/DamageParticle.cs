...
public class DamageParticle : MonoBehaviour
{
    ...
    public void Init(Define.EDAMAGE_TYPE edamageType, float _damage, bool _isCritical, bool _isAvoid)
    {
        ...
        else
        {
            switch (edamageType)
            {   
                case Define.EDAMAGE_TYPE.PHYSICAL:
                    damageText.color = Color.white;
                    break;
                case Define.EDAMAGE_TYPE.MAGICAL:
