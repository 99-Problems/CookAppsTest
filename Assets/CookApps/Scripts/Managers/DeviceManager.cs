...
public class DeviceManager
{
    ...
    public bool startSceneintro1End = false;
    public bool agitCameraFix = false;
...
//    }
    ...
    public void SetScreenResolution(long value = -1)
    {
        ...
        agitCameraFix = (float)resolutionWidth / resolutionHeight > 2.2;
        Screen.SetResolution(resolutionWidth, resolutionHeight, true);
        Debug.Log($"Screen Resolution ({resolutionWidth},{resolutionHeight})");
    }

//    public string[] DetectNormal()
//    {
//#if UNITY_ANDROID && UNITY_EDITOR == false
//        // 파일 체크(임시)
//        {
//            Debug.Log($"DetectNormal ApkImpl.s_root : {BetterStreamingAssets.Root}");
//            var srt = BetterStreamingAssets.GetFiles("/");
//            return srt;
//        }
//#endif
//        return null;
